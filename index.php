  ...
  <body class="leading-normal tracking-normal text-white gradient" style="font-family: 'Source Sans Pro', sans-serif;">
      ...
      <div class="w-full container mx-auto flex flex-wrap items-center justify-between mt-0 py-2">
        ...
        <div class="w-full flex-grow lg:flex lg:items-center lg:w-auto hidden mt-2 lg:mt-0 bg-white lg:bg-transparent text-black p-4 lg:p-0 z-20" id="nav-content">
          <ul class="list-reset lg:flex justify-end flex-1 items-center">
            ...
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="#aboutus">About Us</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="transfermoney.php">Transfer Money</a>
            </li>
            <li class="mr-3">
              <a class="inline-block text-black no-underline hover:text-gray-800 hover:text-underline py-2 px-4" href="transactionhistory.php">Transaction History</a>
            </li>
    ...
    <div class="pt-24">
      <div class="container px-3 mx-auto flex flex-wrap flex-col md:flex-row items-center">
        ...
        <div class="flex flex-col w-full md:w-2/5 justify-center items-start text-center md:text-left">
          <p class="uppercase tracking-loose w-full">Banking Website</p>
          <h1 class="my-4 text-5xl font-bold leading-tight">
            Bank of India
          </h1>
          <p class="leading-normal text-2xl mb-8">
            Helps you to made easy money transfer
          </p>
        ...
        <div class="w-full md:w-3/5 py-6 text-center">
          <img class="w-full md:w-3/5 z-40" src="new1.png"  style="border-radius: 50%; float: right; margin-right: 20px;" />
        </div>
      </div>
    </div>
      ...
      <div class="container max-w-5xl mx-auto m-8">
        ...
        <div class="flex flex-wrap">
          <div class="w-5/6 sm:w-1/2 p-6">
            <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3" style="margin:20%;">
               INSTANT MONEY TRANSFER FROM BANK
           </h3>
            <p class="text-gray-600 mb-8" style="margin:20%;>
            A fast, easy way to send money to India
              <br />
              <br />
        ...
        <div class="flex flex-wrap flex-col-reverse sm:flex-row">
          ...
          <div class="w-full sm:w-1/2 p-6 mt-6">
            <div class="align-middle">
              <h3 class="text-3xl text-gray-800 font-bold leading-none mb-3" style="margin-top:5%;display:inline;">
                
                <ol>
                <li>Sending to account</li>
                <li>Sending to  a person directly</li>
                <li>Paying bills</li>
    ...
    <section class="bg-white border-b py-8">
      <div class="container mx-auto flex flex-wrap pt-4 pb-12">
        ...
        <div class="row activity text-center" style="display: inline;">
         
          <div class="card" style="width: 18rem; float: left; margin: 85px;border: 10px solid black; box-shadow: 5px 15px rgb(245, 16, 104)">
              <img src="vats.jpeg" class="card-img-top" width="700px"  alt="...">
              <div class="card-body">
                  <h5 class="card-title" style="color: black;">Create User</h5>
                  <button style="background-color: blue; border-radius: 10px; padding: 5px; width: 80%;"><a href="createuser.php" class="btn btn-primary" style="color: black;">Create User</a></button>
                  
              </div>
          </div>
         
          <div class="card" style="width: 18rem; float: left;margin: 85px;border: 10px solid black; height: 68%;box-shadow: 5px 15px rgb(245, 16, 104) ">
              <img src="card1.jpeg" class="card-img-top" width="800px" height="500px"  alt="...">
              <div class="card-body">
                  <h5 class="card-title" style="color: black; margin-top: 40px; margin-bottom: 5px;">Money Transfer</h5>

                 <button style="background-color: blue; border-radius: 10px; padding: 5px; width: 80%; margin-top: 20px;"><a href="transfermoney.php" class="btn btn-primary" style="color: black;">Transfer Money</a></button>
              </div>
          </div>
          
          <div class="card" style="width: 18rem;float: left;margin: 85px;border: 10px solid black; height: 68%;box-shadow: 5px 15px rgb(245, 16, 104) ">
              <img src="card2.png" class="card-img-top" width="700px" height="200px" style="margin-top: 50px;" alt="...">
              <div class="card-body">
                  <h5 class="card-title" style="color: black; margin-top: 60px; margin-bottom: 5px;">Transaction History</h5>

                  <button style="background-color: blue; border-radius: 10px; padding: 5px; width: 80%; margin-top: 5px;"> <a href="transactionhistory.php" class="btn btn-primary" style="color: black;">Transaction History</a></button>
              </div>
          </div>
      </div>
    ...
    <section class="bg-gray-100 py-8">
      <div class="container mx-auto px-2 pt-4 pb-12 text-gray-800">
        <h1 class="w-full my-2 text-5xl font-bold leading-tight text-center text-gray-800" id="aboutus">
          About US
        </h1>
        <div class="w-full mb-4">
          <div class="h-1 mx-auto gradient w-64 opacity-25 my-0 py-0 rounded-t"></div>
        </div>
        <blockquote style="color: black;">The Bank of India was established following the Bank of India Act of 1934.
          Though privately owned initially, it was nationalised in 1949 and since then fully owned by
          the Ministry of Finance , Government of India (GoI).
          In 1926, the Hilton Young Commission recommended the setting up of the  Bank of India.
          At the time of establishment, the authorized capital of the Bank of India was Rs. 5 crores.
          The government's share in this was only Rs 20-22 lakhs.<br>The preamble of the Bank of India
          describes the basic functions of the bank as:[11]

          "to regulate the issue of Bank notes and keeping of reserves with a view to securing monetary stability in
          India and generally to operate the currency and credit system of th
          e country to its advantage; to have a modern monetary policy framework to meet the challenge of an
          ...
          commercial banks. It also works for overall economic growth of the country. The preamble of the Bank
          of India describes its main functions as:
    ...
    <footer class="text-center mt-5 py-2">
      <p>&copy 2021. Made with &hearts; by <b>Shikhar Singhal</b> <br>Web Developer Intern @ Sparks Foundation </p>
  </footer>
